			...
			<div class="contai">
				...
				<div class="row row-flex">
					...
					<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
						<img class="img-responsive" src="{{ asset('images/product1.png') }}" alt="video">
					</div>
				...
				<form method="post" action="javascript:;" name="frmContato" id="frmContato" autocomplete="on">
					...
					<div class="row">
						...
						<div class="col-md-6">
        					<!-- Telefone -->
        					<div>
        						<input class="inputLogin sp_celphones" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" id="phone" name="telefone" type="text" id="telefone" placeholder="Telefone" required="required" />
        					</div>
						</div>
