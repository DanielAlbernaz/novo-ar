...
class Crop_Imagem {
	...
	*/
	...
	public function Crop_Imagem( $origem = '', $extensoes_validas = array( 'jpg', 'jpeg', 'jpe', 'gif', 'bmp', 'png' ) ) 
...

	{
...

		{
			...
			case 6: 
				...
				$this->img = imagecreatebmp( $this->origem ); 
	...
	*/
...

	{
		...
		//fundo com cor
                ...
                $corfundo = imagecolorallocatealpha( $this->img_temp, 0, 0, 0, 127 );
		...
		if ( $imagem ) {
...

			{
				...
				case 'bmp':
					...
					$marcadagua = imagecreatebmp( $imagem );
